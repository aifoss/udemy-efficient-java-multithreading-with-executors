package com.efficient_java_multithreading_with_executors.section10_scheduling_tasks.thread_api;

import com.efficient_java_multithreading_with_executors.common.ScheduledTaskA;
 ...
 */
public class SchedulingTasksForFixedDelayRepeatedExecutionsUsingThreadAPI {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        timer.schedule(task1, scheduledTime, intervalMillis);
        ...
        timer.schedule(task2, delayMillis, intervalMillis);

package com.efficient_java_multithreading_with_executors.section10_scheduling_tasks.executor_api;

import com.efficient_java_multithreading_with_executors.common.NamedThreadFactory;
import com.efficient_java_multithreading_with_executors.common.ScheduledTaskB;
 ...
 */
public class SchedulingTasksForFixedDelayRepeatedExecutionsUsingExecutorAPI {
...
//        ScheduledExecutorService scheduledExecutorService = Executors.newSingleThreadScheduledExecutor(new NamedThreadFactory());
        ...
        ScheduledFuture<?> f1 = scheduledExecutorService.scheduleWithFixedDelay(new ScheduledTaskB(1000), 4, 2, TimeUnit.SECONDS);
        ScheduledFuture<?> f2 = scheduledExecutorService.scheduleWithFixedDelay(new ScheduledTaskB(5000), 4, 2, TimeUnit.SECONDS);
